...
const index = (): React.ReactElement => {
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-20 lg:px-8">
          ...
          <div className="mt-16 lg:mt-20">
            <div className="flex flex-wrap">
              <div className="mb-12 w-full shrink-0 grow-0 basis-auto lg:mb-0 lg:w-5/12 shadow-2xl shadow-blue-500 rounded-lg">
                <iframe
      ...
      {/* contact form */}
      <div className="pt-12 pb-24 flex flex-col justify-center">
        <div className="relative py-3 sm:max-w-xl sm:mx-auto">
          <div className="absolute inset-0 bg-gradient-to-r from-blue-700 to-purple-500 shadow-2xl shadow-blue-500 transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl"></div>
          <div className="text-white relative px-4 py-10 bg-gradient-to-tr from-sky-400 to-blue-500 shadow-lg sm:rounded-3xl sm:p-20">
